...
void handle_lockout()
{
    ...
    while (block < 120)
    {
        ...
        clcd_putch(hundreds + '0', (0xC0 + 4));
        clcd_putch(tens + '0', (0xC0 + 5));
        clcd_putch(ones + '0', (0xC0 + 6));
        clcd_print("sec...", (0xC0 + 8));
    }
